...
const ProductSale: React.FC<ProductCardProps> = ({ product }) => {
  ...
  return (
    <div className='tw-bg-white tw-overflow-hidden tw-transition-transform hover:tw-transform hover:tw-scale-105 tw-h-[350px] sm:tw-h-[380px] tw-flex tw-flex-col tw-border-[2px] tw-cursor-pointer'>
      ...
      <div className='tw-flex tw-flex-col tw-flex-grow tw-p-4'>
        <h3 className='tw-text-lg tw-font-semibold tw-mb-2 tw-line-clamp-2 tw-h-[3.2rem]'>{name}</h3>

        <div className='tw-flex tw-flex-col tw-mt-auto'>
